...
#
# Voraussetzungen: uv, Internet (PyPI). Für den vollen Build (mit Wortliste)
# zusätzlich data/external/twanksta_entries.json (s. README »Setup«); ohne
# diese Datei bitte mit --gold-only aufrufen.
#
